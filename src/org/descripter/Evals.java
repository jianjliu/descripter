...
/**
 * <p>Tests Evaluating JavaScript.</p>
 * 
 ...
 */
public class Evals extends Global<Core>
{
	/**
	...
	@Override
	public void run() {
		eval("print('Hello there!!!!' + Math.sin(Math.PI / 6))");
		eval("print('Hello there!!!!' + Math.sin(Math.PI / 3))");
		eval(
				"print('Hello there!!!!' + " +
				"Math.sqrt(3) / 2)"
		);
		eval("var v = Math.PI, u = Math.cos(v / 4); print(u);");
	}
