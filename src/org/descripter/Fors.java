...
/**
 * <p>Tests JavaScript for-in Statements.</p>
 * 
 ...
 */
public class Fors extends Global<Core>
{
	/**
	 ...
	 * @since Descripter 1.0
	 */
	public Fors(Core with) {
		super(with);
	}

	private final Var v = my("test");
	...
	@Override
	public void run() {
		new MyFor(this, var(with._this), v) {
			@Override
			protected void each() {
				print(v);
				print(var(v));
