 ...
 */
public class HelloWorld extends Global<Core>
{
	/**
	...
	public void run() {
		...
		eval("execute(compile('org.descripter.js.Hello','print(\"HelloWorld!\");'));");
		execute(compile(
				"org.descripter.js.Hello",
				"print('Hello World!')"
		));
		execute(compile(
				"org.descripter.js.Hello",
		...
		execute(compile(
				"org.descripter.js.Hello",
				"var v='Hello World!';eval('print(v)');"
		));
	}
	...
	public static void main(String[] args) {
		HelloWorld hello = new HelloWorld(new Core());
		hello.run();
		hello.run();
		hello.run();
	}
