 ...
 */
public class RegExps extends Global<Core>
{
	/**
	...
	@Override
	public void run() {
		Var R = var(with._RegExp);
		Object r = alloc(R, "o*R", "gigiii");
		print(r);
		print(call(var(r, with._test), "Hello World!"));
		print(var(r, with._ignoreCase));
		set(r, with._ignoreCase, false);
		print(var(r, with._ignoreCase));
	}
