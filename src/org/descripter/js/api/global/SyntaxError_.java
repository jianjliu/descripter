...
/**
 * <p>Emulates the global SyntaxError function in JavaScript.</p>
 * 
 ...
 */
public class SyntaxError_ extends Function<Core>
{
	/**
	...
	public static final void create(Core core) {
		if (core.get(core._SyntaxError) == null) {
			core.put(core._SyntaxError, new SyntaxError_(core));
		}
	}

	private SyntaxError_(Core core) {
		super(core);
	}
