...
/**
 * <p>Emulates the global TypeError function in JavaScript.</p>
 * 
 ...
 */
public class TypeError_ extends Function<Core>
{
	/**
	...
	public static final void create(Core core) {
		if (core.get(core._TypeError) == null) {
			core.put(core._TypeError, new TypeError_(core));
		}
	}

	private TypeError_(Core core) {
		super(core);
	}
