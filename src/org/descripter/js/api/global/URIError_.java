...
/**
 * <p>Emulates the global URIError function in JavaScript.</p>
 * 
 ...
 */
public class URIError_ extends Function<Core>
{
	/**
	...
	public static final void create(Core core) {
		if (core.get(core._URIError) == null) {
			core.put(core._URIError, new URIError_(core));
		}
	}

	private URIError_(Core core) {
		super(core);
	}
